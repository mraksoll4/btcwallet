...
[![GoDoc](https://godoc.org/github.com/mraksoll4/btcwallet/walletdb?status.png)]
(http://godoc.org/github.com/mraksoll4/btcwallet/walletdb)
...
http://localhost:6060/pkg/github.com/mraksoll4/btcwallet/walletdb

## Installation

```bash
$ go get github.com/mraksoll4/btcwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/mraksoll4/btcwallet/walletdb#example-package--BasicUsage)  
