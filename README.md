...
[![Build Status](https://travis-ci.org/mraksoll4/btcwallet.png?branch=master)](https://travis-ci.org/mraksoll4/btcwallet)
...
can be found [here](https://github.com/mraksoll4/btcd).  An alternative
...
https://github.com/mraksoll4/btcwallet/releases
...
```
git clone https://github.com/mraksoll4/btcwallet $GOPATH/src/github.com/mraksoll4/btcwallet
cd $GOPATH/src/github.com/mraksoll4/btcwallet
glide install
```
...
```bash
$ cp $GOPATH/src/github.com/mraksoll4/btcd/sample-btcd.conf ~/.btcd/btcd.conf
$ cp $GOPATH/src/github.com/mraksoll4/btcwallet/sample-btcwallet.conf ~/.btcwallet/btcwallet.conf
...
The [integrated github issue tracker](https://github.com/mraksoll4/btcwallet/issues)
